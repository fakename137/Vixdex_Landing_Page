...
import SwipeableCardSlider from './SwipeableCardSlider';
...
export default function ScrollSections() {
  ...
  useEffect(() => {
    const unsubscribe = sectionProgress.onChange((latest) => {
      const newActiveSection = Math.round(latest);
      if (
        newActiveSection !== activeSection &&
        newActiveSection >= 0 &&
        newActiveSection < sections.length
      ) {
    ...
    <div ref={containerRef} className="min-h-[300vh] relative">
      <div className="sticky top-0 h-screen flex items-center justify-center">
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="flex gap-16 items-center justify-around ml-20">
                ...
                >
                  <div className="space-y-2">
                    <motion.p
                      ...
                      animate={{
                        color: activeSection === index ? '#2dd4bf' : '#6b7280',
            ...
            <div className="relative h-96 w-2/3">
              {sections.map((section, index) => (
                ...
                >
                  ...
                  <motion.h4
                    className="text-gray-300 text-xl font-semibold leading-relaxed max-w-md"
                  ...
                  <motion.p
                    className="text-gray-400 text-sm mt-4 max-w-sm"
